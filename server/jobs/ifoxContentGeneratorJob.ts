...
// Staggered schedule: runs every 5 minutes at offset 4 (4, 9, 14, 19...) to avoid DB contention
export const processScheduledContentTasks = cron.schedule('4,9,14,19,24,29,34,39,44,49,54,59 * * * *', async () => {
  if (isProcessing) {
    return;
  }
...
export function startIfoxContentGeneratorJob() {
  ...
  console.log("[iFox Generator] ✅ Job started (runs every 5 minutes)");
}
